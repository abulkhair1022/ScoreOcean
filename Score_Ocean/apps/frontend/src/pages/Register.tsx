    ...
    <div className="min-h-screen flex bg-[#f8fafc]">
      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-8 lg:px-12 py-8 overflow-y-auto">
        <div className="w-full max-w-lg">
          ...
          <div className="relative flex items-center gap-3 mt-5 mb-3">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 border-2 border-gray-200 rounded-2xl font-semibold text-gray-700 hover:border-gray-300 hover:bg-gray-50 transition-all duration-200"
          >
