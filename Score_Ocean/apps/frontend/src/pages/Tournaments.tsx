...
const STATUS_STYLE: Record<string, { bg: string; text: string; dot: string; label: string }> = {
  ...
  REGISTRATION_CLOSED: { bg: 'bg-orange-100',  text: 'text-orange-700',  dot: 'bg-orange-500',  label: 'Registration Closed' },
  ...
  AUCTION_PENDING:     { bg: 'bg-amber-100',   text: 'text-amber-700',   dot: 'bg-amber-500',   label: '🔨 Auction Pending'  },
  ...
  DRAFT:               { bg: 'bg-amber-100',   text: 'text-amber-700',   dot: 'bg-amber-500',   label: 'Draft'               },
};
          ...
          <div className="mt-auto flex flex-col gap-2">
            {registered ? (
              ...
              <button
                ...
                className={`w-full py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl text-sm font-bold hover:opacity-90 transition-all shadow-sm flex items-center justify-center gap-2`}>
                🚀 Publish Tournament
              </button>
            ) : (
              <button
            ...
            {isLeague && isHost && !auctionEntry && statusKey !== 'DRAFT' && (
              statusKey === 'REGISTRATION_CLOSED' ? (
                ...
                <div className="w-full py-2.5 rounded-xl text-center text-xs font-bold border-2 border-dashed bg-amber-50 text-amber-500 border-amber-200">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {(user?.role === 'ORGANIZATION' || user?.role === 'ADMIN') && (
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-violet-600 to-purple-600 text-white rounded-xl text-sm font-bold hover:from-violet-700 transition-all shadow-sm">
              + Create Tournament
            </button>
          )}
        </div>
      ...
      {showAuctionSetup && auctionSetupTournament && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md animate-fade-in">
            <div className="p-6 bg-gradient-to-br from-amber-500 to-orange-500 text-white rounded-t-3xl">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-black">🔨 Start Auction</h2>
                  <p className="text-amber-100 text-sm mt-0.5">{auctionSetupTournament.name}</p>
                </div>
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input type="number" value={auctionSetupForm.teamBudget}
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-amber-400 focus:outline-none text-sm" />
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl font-bold hover:opacity-90 transition-all disabled:opacity-50 flex items-center justify-center gap-2">
                {creatingAuction
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-fade-in">
            {/* Header */}
            <div className="p-6 bg-gradient-to-br from-violet-600 to-purple-600 text-white">
              <div className="flex items-center justify-between">
                <div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button onClick={handleCreateTournament} disabled={creating}
                  className="flex-1 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 text-white font-bold text-sm hover:from-violet-700 transition-all shadow-sm disabled:opacity-50 flex items-center justify-center gap-2">
